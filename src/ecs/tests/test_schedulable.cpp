...
TEST(RunIf, SystemSkippedWhenConditionFalse) {
  ...
  a.add_system(
      ...
      ecs::schedulable::systems([](ecs::resource::resource<counter_res> c) {
        c->value += 1;
      }).run_if([](ecs::resource::resource_const<flag_res> f) -> bool {
        return f->value;
      }));
...
TEST(RunIf, ConditionAndComposition) {
  ...
  a.add_system(
      ...
      ecs::schedulable::systems(
          ...
          .run_if([](ecs::resource::resource_const<active_res> a) -> bool {
            return a->value;
          }));
...
TEST(Chain, TwoChainsAreIndependent) {
  ...
  a.add_system(ecs::system::system_bind_point::update,
               ecs::schedulable::systems(
                   [&order](ecs::resource::resource<counter_res>) {
                     order.push_back(1);
                   },
                   [&order](ecs::resource::resource<counter_res>) {
                     order.push_back(2);
